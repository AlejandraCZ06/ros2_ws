...
enum
{
  tutorial_interfaces__action__Fibonacci_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  tutorial_interfaces__action__Fibonacci_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Fibonacci in the package tutorial_interfaces.
typedef struct tutorial_interfaces__action__Fibonacci_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  tutorial_interfaces__action__Fibonacci_SendGoal_Request__Sequence request;
  tutorial_interfaces__action__Fibonacci_SendGoal_Response__Sequence response;
} tutorial_interfaces__action__Fibonacci_SendGoal_Event;

// Struct for a sequence of tutorial_interfaces__action__Fibonacci_SendGoal_Event.
typedef struct tutorial_interfaces__action__Fibonacci_SendGoal_Event__Sequence
{
...
enum
{
  tutorial_interfaces__action__Fibonacci_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  tutorial_interfaces__action__Fibonacci_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Fibonacci in the package tutorial_interfaces.
typedef struct tutorial_interfaces__action__Fibonacci_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  tutorial_interfaces__action__Fibonacci_GetResult_Request__Sequence request;
  tutorial_interfaces__action__Fibonacci_GetResult_Response__Sequence response;
} tutorial_interfaces__action__Fibonacci_GetResult_Event;

// Struct for a sequence of tutorial_interfaces__action__Fibonacci_GetResult_Event.
typedef struct tutorial_interfaces__action__Fibonacci_GetResult_Event__Sequence
{
